...
SELECT 1940 "Population Development"
     , 7454995 "New York"
	 , 1759277 "Rio"
...
SELECT 1940 "Population Development"
     , 7.454995 "New York"
	 , 1.759277 "Rio"
     , 6.778804 "Tokio"                FROM dual UNION ALL
SELECT 1950,7.891957,2.375280,5.385071 FROM dual UNION ALL
SELECT 1960,7.781984,3.300431,8.310027 FROM dual UNION ALL
SELECT 1970,7.895563,4.251918,8.840942 FROM dual UNION ALL
SELECT 1980,7.071639,5.090723,8.351893 FROM dual UNION ALL
SELECT 1990,7.322564,5.480768,8.163573 FROM dual UNION ALL
SELECT 2000,8.008278,5.857904,8.134688 FROM dual UNION ALL
SELECT 2010,8.175133,6.320446,8.980768 FROM dual;
```
...
SELECT 'New York' AS "Population Development"  
     , 7454995    AS "1940" 
	 , 8175133    AS "2010"    FROM dual UNION ALL 
SELECT 'Rio',  1759277,6320446 FROM dual UNION ALL
SELECT 'Tokio',6778804,8980768 FROM dual; 
```	

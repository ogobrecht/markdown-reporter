...
#
# Ottmar Gobrecht: 
#     Changed to read from file named document.json and write to file named document.filtered.json
#     File handling is for Python 3 only, for Python 2 you have to rework this
#     Please have a look in lines 70-73 and 81-84
...
def toJSONFilters(actions):
    ...
    pandoc document from FILE, transforms it by walking the tree
    ...
    with codecs.open("document.json", "r", "utf-8") as in_file:
    ...
    with codecs.open("document.filtered.json", "w", "utf-8") as out_file:
        json.dump(altered, out_file, ensure_ascii=False)
    # <-- changed to write to file
